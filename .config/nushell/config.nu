...
use ~/.config/nushell/ls_colors.nu
...
$env.config = {
    ...
    hooks: {
        pre_prompt: [{ echo }] # run before the prompt is shown
...
if 'TMUX' not-in $env and 'TERM_PROGRAM' not-in $env { tmux new-session -A -s main }
